...
gcloud run deploy clearcut-web \
  ...
  --set-env-vars="GOOGLE_GENAI_USE_VERTEXAI=1,GOOGLE_CLOUD_PROJECT=$GOOGLE_CLOUD_PROJECT,GOOGLE_CLOUD_LOCATION=$GOOGLE_CLOUD_LOCATION,MODEL=$MODEL,AGENT_ENGINE_ID=$AGENT_ENGINE_ID"
